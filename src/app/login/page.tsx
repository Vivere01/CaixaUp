        ...
        <div className="bg-white border border-outline-variant/20 p-10 rounded-[2.5rem] shadow-xl shadow-primary/5">
          <form action={formAction} className="space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="email" className="text-on-surface font-semibold ml-1">E-mail</Label>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-1">
                <Label htmlFor="password" className="text-on-surface font-semibold">Senha</Label>
                <Link
